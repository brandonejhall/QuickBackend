...
export default function DashboardStats() {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      ...
      <Card className="border-brims-orange/20">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium text-brims-orange">Storage Used</CardTitle>
          <Upload className="h-4 w-4 text-brims-orange" />
        </CardHeader>
        <CardContent>
